...
const listaPokemon = [
    ...
    new pokemon (103, 'exeggutor', 'planta', 'veneno'),
    new pokemon (104, 'cubone', 'tierra', 'none'),
    new pokemon (105, 'marowak', 'tierra', 'none'),
    new pokemon (106, 'hitmonlee', 'pelea', 'none'),
    new pokemon (107, 'hitmonchan', 'pelea', 'none'),
    new pokemon (108, 'lickitung', 'normal', 'none'),
    new pokemon (109, 'koffing', 'veneno', 'none'),
    new pokemon (110, 'weezing', 'veneno', 'none'),
    new pokemon (111, 'rhyhorn', 'tierra', 'roca'),
    new pokemon (112, 'rhydon', 'tierra', 'roca'),
    new pokemon (113, 'chansey', 'normal', 'none'),
    new pokemon (114, 'tangela', 'planta', 'none'),
    new pokemon (115, 'kangaskhan', 'normal', 'none'),
    new pokemon (116, 'horsea', 'agua', 'none'),
    new pokemon (117, 'seadra', 'agua', 'none'),
    new pokemon (118, 'goldeen', 'agua', 'none'),
    new pokemon (119, 'seaking', 'agua', 'none'),
    new pokemon (120, 'staryu', 'agua', 'none'),
    new pokemon (121, 'starmie', 'agua', 'psiquico'),
    new pokemon (122, 'mr mime', 'psiquico', 'hada'),
    new pokemon (123, 'scyther', 'bicho', 'acero'),
    new pokemon (124, 'jynx', 'hielo', 'psiquico'),
    new pokemon (125, 'electabuzz', 'electrico', 'none'),
    new pokemon (126, 'magmar', 'fuego', 'none'),
    new pokemon (127, 'pinsir', 'bicho', 'none'),
    new pokemon (128, 'tauros', 'normal', 'none'),
    new pokemon (129, 'magikarp', 'agua', 'none'),
    new pokemon (130, 'gyarados', 'agua', 'volador'),
    new pokemon (131, 'lapras', 'agua', 'hielo'),
    new pokemon (132, 'ditto', 'normal', 'none'),
    new pokemon (133, 'eevee', 'normal', 'none'),
    new pokemon (134, 'vaporeon', 'agua', 'none'),
    new pokemon (135, 'jolteon', 'electrico', 'none'),
    new pokemon (136, 'flareon', 'fuego', 'none'),
    new pokemon (137, 'porygon', 'normal', 'none'),
    new pokemon (138, 'omanyte', 'roca', 'agua'),
    new pokemon (139, 'omaster', 'roca', 'agua'),
    new pokemon (140, 'kabuto', 'roca', 'agua'),
    new pokemon (141, 'kabutops', 'roca', 'agua'),
    new pokemon (142, 'aerodactyl', 'roca', 'volador'),
    new pokemon (143, 'snorlax', 'normal', 'none'),
    new pokemon (144, 'articuno', 'hielo', 'volador'),
    new pokemon (145, 'zapdos', 'electrico', 'volador'),
    new pokemon (146, 'moltres', 'fuego', 'volador'),
    new pokemon (147, 'dratini', 'dragon', 'none'),
    new pokemon (148, 'dragonair', 'dragon', 'none'),
    new pokemon (149, 'dragonite', 'dragon', 'volador'),
    new pokemon (150, 'mewtwo', 'psiquico', 'none'),
    new pokemon (151, 'mew', 'psiquico', 'none'),
